...
local Miragecheck = v1:Paragraph({
    Title = "Mirage Island",
    Content = "Status: "
})
spawn(function()
...
local Kitsunecheck = v1:Paragraph({
...
local CPrehistoriccheck = v1:Paragraph({
...
local FrozenIsland = v1:Paragraph({
...
local MobCakePrince = v1:Paragraph({
...
local TyrantStatus = v1:Paragraph({
...
local CheckDoughKing = v1:Paragraph({
    Title = "Dough King",
    Content = "Status: "
})
spawn(function()
...
local EliteHunter = v1:Paragraph({
    Title = "Elite Hunter",
    Content = "Status: "
})
spawn(function()
...
local LegendarySword = v1:Paragraph({
...
local targetDisplay = v4:Paragraph({
...
local BossDropdown = v2:AddDropdown("Zyn_Dropdown_6", {
    Title = "Select Boss",
    Values = Boss,
...
v2:AddToggle("Zyn_Toggle_22", { Title = "Use Skill Z (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.Z = v end })
v2:AddToggle("Zyn_Toggle_23", { Title = "Use Skill X (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.X = v end })
v2:AddToggle("Zyn_Toggle_24", { Title = "Use Skill C (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.C = v end })
v2:AddToggle("Zyn_Toggle_25", { Title = "Use Skill V (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.V = v end })
v2:AddToggle("Zyn_Toggle_26", { Title = "Use Skill F (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.F = v end })
...
if World1 then
    ...
    local TravelDresToggle = v3:AddToggle("Zyn_Toggle_40", {
...
if World2 then
    ...
    local AutoZouToggle = v3:AddToggle("Zyn_Toggle_41", {
...
if World3 then
    ...
    local EliteProgressPara = v3:Paragraph({ Title = "Elites Process ", Desc = "" });
    spawn(function()
        while wait(Sec) do
            pcall(function()
...
if World3 then
    ...
    local SoulGuitarStatus = v3:Paragraph({
...
if World3 then
    ...
    local CDKProgress = v3:Paragraph({
        Title = "CDK Progress",
...
v6:AddDropdown("Zyn_Dropdown_10", {
        Title = "Select Boats",
        Values = BoatList,
        Default = "Guardian",
        Multi = false,
...
if World3 then
        ...
        v6:AddDropdown("Zyn_Dropdown_11", {
...
local PrehistoricStatus = v7:Paragraph({
...
local KillAuraDisplay = v7:Paragraph({
...
-- Full Moon Status
local FullMoonStatus = v8:Paragraph({
    Title = "Full Moon Status",
    Content = "Checking..."
})

-- Mirage Island Status
local MirageIslandStatus = v8:Paragraph({
...
-- Tiers V4 Status
local TiersStatus = v8:Paragraph({
...
local StockParagraph = v9:Paragraph({
    Title = "Fruit Stock",
    Content = "Loading..."
})
...
-- Dropdown chọn fruit
v9:AddDropdown("Zyn_Dropdown_12", {
...
v9:AddDropdown("Zyn_Dropdown_13", {
...
local FruitCheckResult = v9:Paragraph({
    Title = "Fruit Status",
...
local RaidTimerStatus = v10:Paragraph({
    Title = "Raid Timer",
    Content = "Not in raid"
})

local RaidIslandStatus = v10:Paragraph({
    Title = "Current Island",
    Content = "None"
})

local RaidMobsStatus = v10:Paragraph({
...
v10:AddDropdown("Zyn_Dropdown_14", {
    Title = "Select Chip",
    Values = RaidChipList,
...
local KillAuraCounter = 0
local KillAuraDisplay = v10:Paragraph({
    Title = "Kill Aura Stats",
    Content = "Killed: 0"
})
...
-- Dropdown
v11:AddDropdown("Zyn_Dropdown_15", {
...
v11:AddDropdown("Zyn_Dropdown_16", {
    Title = "Select Portal",
...
v11:AddDropdown("Zyn_Dropdown_17", {
    Title = "Select NPCs",
    Values = NPCList,
    Default = false,
    Multi = false,
...
-- Dropdown chọn Melee
v14:AddDropdown("Zyn_Dropdown_18", {
...
v15:AddDropdown("Zyn_Dropdown_19", {
...
v15:AddDropdown("Zyn_Dropdown_20", {
    Title = "Select Time",
    Values = TimeOptions,
    Default = "Day",
    Callback = function(Value)
...
local PlayerDropdown = v12:AddDropdown("Zyn_Dropdown_21", {
