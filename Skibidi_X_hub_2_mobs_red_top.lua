...
local function CreateSkibidiTopTag()
    ...
    label.Text = "Skibidi X hub On Top"
    label.TextSize = 18
...
local Fluent, SaveManager, InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/tv7775464-netizen/Maruhub/refs/heads/main/GET_Apple_MeoMao_ALL_IMAGES.lua"))()
...
local Tabs = {
    ...
    Info = wrapTab(Window:AddTab({ Title = "Info & Status", Icon = "Info" })),
