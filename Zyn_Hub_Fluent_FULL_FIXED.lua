-- UI BOOTSTRAP: create the window before feature initialization.
local Fluent, SaveManager, InterfaceManager
local uiOk, uiErr = pcall(function()
    Fluent, SaveManager, InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/xshiba/OBFUP/refs/heads/main/GET.lua"))()
    if not Fluent then error("Fluent library failed to load") end
end)
if not uiOk then
    warn("Zyn Hub UI bootstrap failed: " .. tostring(uiErr))
    return
end
...
local DiscordTab = Window:AddTab({Title = "Discord", Icon = "message-circle"})
local DiscordSection = DiscordTab:AddSection("Discord")
    ...
    Callback = function()
        pcall(function()
            if setclipboard then
                setclipboard("https://discord.gg/f4J9ZBWxy")
                Fluent:Notify({Title = "Discord", Content = "Đã copy link Discord", Duration = 2})
            end
        end)
    end
})
...
ConfigSection:AddButton({
    ...
    Callback = function()
        pcall(function()
            SaveSettings()
            Fluent:Notify({Title = "Config", Content = "Đã lưu config", Duration = 2})
        end)
    end
})
ConfigSection:AddButton({
    ...
    Callback = function()
        pcall(function()
            LoadSettings()
            Fluent:Notify({Title = "Config", Content = "Đã tải config", Duration = 2})
        end)
    end
})

_G.__ZYN_FLUENT = Fluent
_G.__ZYN_SAVEMANAGER = SaveManager
_G.__ZYN_INTERFACEMANAGER = InterfaceManager
...
G.Pos = function(I, e)
		...
		return hrp and (Root.Position - hrp.Position).Magnitude <= e;
	end;
G.Dist = function(I, e)
...
local Timmessss = v1MainSection:AddParagraph({
    Title = "Time",
    Content = ""
})
function UpdateTime()
...
local Miragecheck = v1MainSection:AddParagraph({
    Title = "Mirage Island",
    Content = "Status: "
})
spawn(function()
...
local Kitsunecheck = v1MainSection:AddParagraph({
...
local CPrehistoriccheck = v1MainSection:AddParagraph({
...
local FrozenIsland = v1MainSection:AddParagraph({
...
local MobCakePrince = v1MainSection:AddParagraph({
...
local TyrantStatus = v1MainSection:AddParagraph({
...
local CheckRip = v1MainSection:AddParagraph({
    Title = "Rip_Indra",
    Content = "Status: "
})
spawn(function()
...
local CheckDoughKing = v1MainSection:AddParagraph({
    Title = "Dough King",
    Content = "Status: "
})
spawn(function()
...
local EliteHunter = v1MainSection:AddParagraph({
    Title = "Elite Hunter",
    Content = "Status: "
})
spawn(function()
...
local Pullever = v1MainSection:AddParagraph({
    Title = "Pull Lever",
    Content = "Status: "
})
spawn(function()
...
local FM = v1MainSection:AddParagraph({
    Title = "Full Moon",
    Content = ""
})
spawn(function()
...
local LegendarySword = v1MainSection:AddParagraph({
...
local Bone = v1MainSection:AddParagraph({
    Title = "Bone",
    Content = ""
})
spawn(function()
...
v1MainSection:AddInput("Zyn_TextBox_1", {
    Title = "Input Job Id",
    Placeholder = "Job ID",
    ClearOnFocus = true,
...
v1MainSection:AddToggle("Zyn_Toggle_1", {
    Title = "Spam Join",
    Default = false,
    Callback = function(Value)
        getgenv().Join = Value
...
v4MainSection:AddDropdown("Zyn_Dropdown_1", {
...
v4MainSection:AddToggle("Zyn_Toggle_2", {
...
v4MainSection:AddToggle("Zyn_Toggle_3", {
...
v4MainSection:AddDropdown("Zyn_Dropdown_2", {
...
v4MainSection:AddSlider("Zyn_Slider_1", {
    Title = "Gun range",
    Min = 50,
    Max = 30000,
    Default = 500,
...
v4MainSection:AddToggle("Zyn_Toggle_4", {
    Title = "Auto gun aura",
    Default = false,
    Callback = function(val)
...
v4MainSection:AddToggle("Zyn_Toggle_5", {
...
local targetDisplay = v4MainSection:AddParagraph({
...
v2MainSection:AddDropdown("Zyn_Dropdown_3", {
    Title = "Select Weapon",
...
v2MainSection:AddDropdown("Zyn_Dropdown_4", {
...
v2MainSection:AddToggle("Zyn_Toggle_6", {
    Title = "Start Farm",
...
v2MainSection:AddToggle("Zyn_Toggle_7", {
    Title = "Accept Quests",
...
v2MainSection:AddToggle("Zyn_Toggle_8", {
...
if World2 then
v2MainSection:AddToggle("Zyn_Toggle_9", {
...
if World3 then
v2MainSection:AddToggle("Zyn_Toggle_10", {
...
v2MainSection:AddToggle("Zyn_Toggle_11", {
...
v2MainSection:AddToggle("Zyn_Toggle_12", {
...
v2MainSection:AddDropdown("Zyn_Dropdown_5", {
...
v2MainSection:AddToggle("Zyn_Toggle_13", {
	Title = "Auto Farm",
...
v2MainSection:AddToggle("Zyn_Toggle_14", {
    Title = "Trade Bone",
    Default = false,
    Callback = function(Value)
        _G.Rdbone = Value
...
v2MainSection:AddToggle("Zyn_Toggle_15", {
...
v2MainSection:AddToggle("Zyn_Toggle_16", {
    Title = "Auto Pray",
    Default = false,
    Callback = function(v)
        _G.Pray = v
...
v2MainSection:AddToggle("Zyn_Toggle_17", {
    Title = "Auto Try Luck",
    Default = false,
    Callback = function(v)
        _G.Trylux = v
...
local BossStatus = v2MainSection:AddParagraph({
...
local BossDropdown = v2MainSection:AddDropdown("Zyn_Dropdown_6", {
    Title = "Select Boss",
    Values = Boss,
...
v2MainSection:AddToggle("Zyn_Toggle_18", {
...
v2MainSection:AddToggle("Zyn_Toggle_19", {
...
v2MainSection:AddToggle("Zyn_Toggle_20", {
...
v2MainSection:AddDropdown("Zyn_Dropdown_7", {
...
-- MASTERY FRUIT
-- ========================================
v2MainSection:AddToggle("Zyn_Toggle_21", {
...
v2MainSection:AddToggle("Zyn_Toggle_22", { Title = "Use Skill Z (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.Z = v end })
v2MainSection:AddToggle("Zyn_Toggle_23", { Title = "Use Skill X (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.X = v end })
v2MainSection:AddToggle("Zyn_Toggle_24", { Title = "Use Skill C (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.C = v end })
v2MainSection:AddToggle("Zyn_Toggle_25", { Title = "Use Skill V (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.V = v end })
v2MainSection:AddToggle("Zyn_Toggle_26", { Title = "Use Skill F (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.F = v end })
...
-- MASTERY GUN
-- ========================================
v2MainSection:AddToggle("Zyn_Toggle_27", {
...
v2MainSection:AddToggle("Zyn_Toggle_28", {
...
v4MainSection:AddToggle("Zyn_Toggle_29", {
...
v4MainSection:AddToggle("Zyn_Toggle_30", {
...
v4MainSection:AddToggle("Zyn_Toggle_31", {
...
v4MainSection:AddToggle("Zyn_Toggle_32", {
	Title = "Anti AFK",
	Default = true,
	Callback = function(I)
		_G.AntiAFK = I;
...
v4MainSection:AddToggle("Zyn_Toggle_33", {
...
v4MainSection:AddToggle("Zyn_Toggle_34", {
	Title = "Walk on Water",
	Default = true,
	Callback = function(I)
		_G.WalkWater_Part = I;
...
v4MainSection:AddInput("Zyn_TextBox_2", {
...
v4MainSection:AddInput("Zyn_TextBox_3", {
...
v4MainSection:AddInput("Zyn_TextBox_4", {
    Title = "Tween Speed",
    Placeholder = "300",
    Default = "300",
    Callback = function(I)
...
v4MainSection:AddToggle("Zyn_Toggle_35", {
...
v4MainSection:AddToggle("Zyn_Toggle_36", {
    Title = "No Clip",
...
v4MainSection:AddToggle("Zyn_Toggle_37", {
...
v4MainSection:AddSlider("Zyn_Slider_2", {
...
-- 1. SELEÇÃO DE VARA
v5MainSection:AddDropdown("Zyn_Dropdown_8", {
...
-- 2. SELEÇÃO DE ISCA
v5MainSection:AddDropdown("Zyn_Dropdown_9", {
    Title = "Select Bait",
    Values = {
        "Basic Bait",
        "Kelp Bait",
...
v5MainSection:AddToggle("Zyn_Toggle_38", {
    Title = "Auto Buy Bait",
...
v5MainSection:AddToggle("Zyn_Toggle_39", {
    Title = "Auto Fishing",
...
if World1 then
    ...
    local TravelDresToggle = v3MainSection:AddToggle("Zyn_Toggle_40", {
...
if World2 then
    ...
    local AutoZouToggle = v3MainSection:AddToggle("Zyn_Toggle_41", {
...
v5MainSection:AddToggle("Zyn_Toggle_42", {
...
v5MainSection:AddToggle("Zyn_Toggle_43", {
...
-- 7. AUTO SELL FISH
v5MainSection:AddToggle("Zyn_Toggle_44", {
...
-- 8. AUTO SPAM SKILL Z
v5MainSection:AddToggle("Zyn_Toggle_45", {
...
v3MainSection:AddToggle("Zyn_Toggle_46", {
...
if World3 then
    v3MainSection:AddToggle("Zyn_Toggle_47", {
    ...
    -- AUTO CITIZEN QUEST
    v3MainSection:AddToggle("Zyn_Toggle_48", {
    ...
    local EliteProgressPara = v3MainSection:AddParagraph({ Title = "Elites Process ", Desc = "" });
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    v3MainSection:AddToggle("Zyn_Toggle_49", {
    ...
    v3MainSection:AddToggle("Zyn_Toggle_50", {
    ...
    v3MainSection:AddToggle("Zyn_Toggle_51", {
    ...
    v3MainSection:AddToggle("Zyn_Toggle_52", {
...
if World2 or World3 then
    ...
    v3MainSection:AddToggle("Zyn_Toggle_53", {
...
-- ========================================
if World3 then
    v3MainSection:AddToggle("Zyn_Toggle_54", {
...
-- ACCEPT QUEST BYPASS
-- ========================================
v3MainSection:AddToggle("Zyn_Toggle_55", {
...
if World2 then
    ...
    v3MainSection:AddToggle("Zyn_Toggle_56", {
...
-- ========================================
if World1 then
    v3MainSection:AddToggle("Zyn_Toggle_57", {
...
-- ========================================
if World2 then
    v3MainSection:AddToggle("Zyn_Toggle_58", {
...
-- ========================================
if World1 then
    v3MainSection:AddToggle("Zyn_Toggle_59", {
...
-- ========================================
if World1 then
    v3MainSection:AddToggle("Zyn_Toggle_60", {
...
-- ========================================
if World1 then
    v3MainSection:AddToggle("Zyn_Toggle_61", {
...
-- ========================================
if World2 then
    v3MainSection:AddToggle("Zyn_Toggle_62", {
...
-- ========================================
if World2 then
    v3MainSection:AddToggle("Zyn_Toggle_63", {
    ...
    v3MainSection:AddToggle("Zyn_Toggle_64", {
...
-- ========================================
if World2 or World3 then
    v3MainSection:AddToggle("Zyn_Toggle_65", {
...
-- ========================================
if World1 then
    v3MainSection:AddToggle("Zyn_Toggle_66", {
...
-- ========================================
if World3 then
    v3MainSection:AddToggle("Zyn_Toggle_67", {
    ...
    local SoulGuitarStatus = v3MainSection:AddParagraph({
...
if World3 then
    ...
    local CDKProgress = v3MainSection:AddParagraph({
        Title = "CDK Progress",
    ...
    v3MainSection:AddToggle("Zyn_Toggle_68", {
        Title = "Auto Yama CDK",
    ...
    v3MainSection:AddToggle("Zyn_Toggle_69", {
    ...
    v3MainSection:AddToggle("Zyn_Toggle_70", {
...
if World3 then
    ...
    v3MainSection:AddToggle("Zyn_Toggle_71", {
...
-- ========================================
if World2 then
    v3MainSection:AddToggle("Zyn_Toggle_72", {
...
-- ========================================
if World3 then
    v3MainSection:AddToggle("Zyn_Toggle_73", {
...
-- ========================================
if World3 then
    v3MainSection:AddToggle("Zyn_Toggle_74", {
...
-- ========================================
if World3 then
    v3MainSection:AddToggle("Zyn_Toggle_75", {
...
v6MainSection:AddDropdown("Zyn_Dropdown_10", {
        Title = "Select Boats",
        Values = BoatList,
        Default = "Guardian",
        Multi = false,
...
if World3 then
        ...
        v6MainSection:AddDropdown("Zyn_Dropdown_11", {
...
v6MainSection:AddToggle("Zyn_Toggle_76", {
...
v6MainSection:AddToggle("Zyn_Toggle_77", {
    Title = "No Clip Ship",
...
v6MainSection:AddToggle("Zyn_Toggle_78", {
...
v6MainSection:AddInput("Zyn_TextBox_5", {
...
v6MainSection:AddToggle("Zyn_Toggle_79", {
...
v6MainSection:AddToggle("Zyn_Toggle_80", {
...
v6MainSection:AddToggle("Zyn_Toggle_81", {
...
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
    v6MainSection:AddToggle("Zyn_Toggle_82", {
        Title = "Auto Shark",
        Default = false,
        Callback = function(Value)
            _G.Shark = Value
    ...
    v6MainSection:AddToggle("Zyn_Toggle_83", {
        Title = "Auto Piranha",
        Default = false,
        Callback = function(Value)
            _G.Piranha = Value
    ...
    v6MainSection:AddToggle("Zyn_Toggle_84", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_85", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_86", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_87", {
...
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
    ...
    v6MainSection:AddToggle("Zyn_Toggle_88", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_89", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_90", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_91", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_92", {
    ...
    v6MainSection:AddToggle("Zyn_Toggle_93", {
...
-- Melee Skills
v6MainSection:AddToggle("Zyn_Toggle_94", {
    Title = "Melee Z",
...
v6MainSection:AddToggle("Zyn_Toggle_95", {
    Title = "Melee X",
...
v6MainSection:AddToggle("Zyn_Toggle_96", {
    Title = "Melee C",
...
-- Sword Skills
v6MainSection:AddToggle("Zyn_Toggle_97", {
    Title = "Sword Z",
...
v6MainSection:AddToggle("Zyn_Toggle_98", {
    Title = "Sword X",
...
-- Blox Fruit Skills
v6MainSection:AddToggle("Zyn_Toggle_99", {
    Title = "Blox Fruit Z",
...
v6MainSection:AddToggle("Zyn_Toggle_100", {
    Title = "Blox Fruit X",
...
v6MainSection:AddToggle("Zyn_Toggle_101", {
    Title = "Blox Fruit C",
...
v6MainSection:AddToggle("Zyn_Toggle_102", {
    Title = "Blox Fruit V",
...
v6MainSection:AddToggle("Zyn_Toggle_103", {
    Title = "Blox Fruit F",
...
-- Gun Skills
v6MainSection:AddToggle("Zyn_Toggle_104", {
    Title = "Gun Z",
...
v6MainSection:AddToggle("Zyn_Toggle_105", {
    Title = "Gun X",
...
local PrehistoricStatus = v7MainSection:AddParagraph({
...
-- Toggles cho Melee
v7MainSection:AddToggle("Zyn_Toggle_106", {
...
v7MainSection:AddToggle("Zyn_Toggle_107", {
...
v7MainSection:AddToggle("Zyn_Toggle_108", {
...
-- Toggles cho Sword
v7MainSection:AddToggle("Zyn_Toggle_109", {
...
v7MainSection:AddToggle("Zyn_Toggle_110", {
...
v7MainSection:AddToggle("Zyn_Toggle_111", {
...
v7MainSection:AddToggle("Zyn_Toggle_112", {
...
v7MainSection:AddToggle("Zyn_Toggle_113", {
...
v7MainSection:AddToggle("Zyn_Toggle_114", {
...
v7MainSection:AddToggle("Zyn_Toggle_115", {
...
-- Toggles cho Gun
v7MainSection:AddToggle("Zyn_Toggle_116", {
...
v7MainSection:AddToggle("Zyn_Toggle_117", {
...
v7MainSection:AddToggle("Zyn_Toggle_118", {
...
v7MainSection:AddToggle("Zyn_Toggle_119", {
...
-- Auto Patch (Xóa lava)
v7MainSection:AddToggle("Zyn_Toggle_120", {
...
v7MainSection:AddToggle("Zyn_Toggle_121", {
    Title = "Kill Aura",
    Default = _G.KillAura,
    Callback = function(Value)
        _G.KillAura = Value
...
local KillAuraDisplay = v7MainSection:AddParagraph({
...
v7MainSection:AddToggle("Zyn_Toggle_122", {
...
v7MainSection:AddToggle("Zyn_Toggle_123", {
...
v7MainSection:AddToggle("Zyn_Toggle_124", {
...
v7MainSection:AddToggle("Zyn_Toggle_125", {
...
v7MainSection:AddToggle("Zyn_Toggle_126", {
...
-- Auto Drago V1
v7MainSection:AddToggle("Zyn_Toggle_127", {
...
v7MainSection:AddToggle("Zyn_Toggle_128", {
...
-- Auto Drago V3
v7MainSection:AddToggle("Zyn_Toggle_129", {
...
v7MainSection:AddToggle("Zyn_Toggle_130", {
...
-- Auto Train Drago V4
v7MainSection:AddToggle("Zyn_Toggle_131", {
...
v7MainSection:AddToggle("Zyn_Toggle_132", {
...
-- Swap Drago Race
v7MainSection:AddToggle("Zyn_Toggle_133", {
...
v7MainSection:AddToggle("Zyn_Toggle_134", {
...
-- Auto Dojo Trainer
v7MainSection:AddToggle("Zyn_Toggle_135", {
...
v7MainSection:AddToggle("Zyn_Toggle_136", {
...
-- Full Moon Status
local FullMoonStatus = v8MainSection:AddParagraph({
    Title = "Full Moon Status",
    Content = "Checking..."
})

-- Mirage Island Status
local MirageIslandStatus = v8MainSection:AddParagraph({
...
v8MainSection:AddToggle("Zyn_Toggle_137", {
...
v8MainSection:AddToggle("Zyn_Toggle_138", {
...
v8MainSection:AddToggle("Zyn_Toggle_139", {
...
-- Esp Mirage Island
v8MainSection:AddToggle("Zyn_Toggle_140", {
...
v8MainSection:AddToggle("Zyn_Toggle_141", {
...
v8MainSection:AddToggle("Zyn_Toggle_142", {
...
-- Auto Collect Gear
v8MainSection:AddToggle("Zyn_Toggle_143", {
...
v8MainSection:AddToggle("Zyn_Toggle_144", {
...
-- Tiers V4 Status
local TiersStatus = v8MainSection:AddParagraph({
...
-- Auto Pull Lever
v8MainSection:AddToggle("Zyn_Toggle_145", {
...
-- Auto Train V4
v8MainSection:AddToggle("Zyn_Toggle_146", {
    Title = "Auto Train V4",
...
v8MainSection:AddToggle("Zyn_Toggle_147", {
...
v8MainSection:AddToggle("Zyn_Toggle_148", {
...
v8MainSection:AddToggle("Zyn_Toggle_149", {
...
-- Auto Look At Moon
v8MainSection:AddToggle("Zyn_Toggle_150", {
...
-- Look Moon + Auto V3
v8MainSection:AddToggle("Zyn_Toggle_151", {
...
-- Auto Upgrade Mink
v8MainSection:AddToggle("Zyn_Toggle_152", {
...
-- Auto Upgrade Human
v8MainSection:AddToggle("Zyn_Toggle_153", {
...
v8MainSection:AddToggle("Zyn_Toggle_154", {
...
v8MainSection:AddToggle("Zyn_Toggle_155", {
...
local StockParagraph = v9MainSection:AddParagraph({
    Title = "Fruit Stock",
    Content = "Loading..."
})
...
-- Auto Random Fruit
v9MainSection:AddToggle("Zyn_Toggle_156", {
...
-- Auto Drop Fruit
v9MainSection:AddToggle("Zyn_Toggle_157", {
...
-- Auto Store Fruit
v9MainSection:AddToggle("Zyn_Toggle_158", {
...
-- Auto Tween to Fruit
v9MainSection:AddToggle("Zyn_Toggle_159", {
...
v9MainSection:AddToggle("Zyn_Toggle_160", {
...
-- Dropdown chọn fruit
v9MainSection:AddDropdown("Zyn_Dropdown_12", {
...
-- Auto Buy Fruit Shop
v9MainSection:AddToggle("Zyn_Toggle_161", {
...
v9MainSection:AddDropdown("Zyn_Dropdown_13", {
...
local FruitCheckResult = v9MainSection:AddParagraph({
    Title = "Fruit Status",
...
v9MainSection:AddToggle("Zyn_Toggle_162", {
...
local RaidTimerStatus = v10MainSection:AddParagraph({
    Title = "Raid Timer",
    Content = "Not in raid"
})

local RaidIslandStatus = v10MainSection:AddParagraph({
    Title = "Current Island",
    Content = "None"
})

local RaidMobsStatus = v10MainSection:AddParagraph({
...
v10MainSection:AddDropdown("Zyn_Dropdown_14", {
    Title = "Select Chip",
    Values = RaidChipList,
...
v10MainSection:AddToggle("Zyn_Toggle_163", {
...
v10MainSection:AddToggle("Zyn_Toggle_164", {
...
v10MainSection:AddToggle("Zyn_Toggle_165", {
...
v10MainSection:AddToggle("Zyn_Toggle_166", {
...
v10MainSection:AddToggle("Zyn_Toggle_167", {
...
v10MainSection:AddToggle("Zyn_Toggle_168", {
...
v10MainSection:AddToggle("Zyn_Toggle_169", {
...
v10MainSection:AddToggle("Zyn_Toggle_170", {
...
v10MainSection:AddToggle("Zyn_Toggle_171", {
...
v10MainSection:AddToggle("Zyn_Toggle_172", {
...
v10MainSection:AddToggle("Zyn_Toggle_173", {
    Title = "Kill Aura",
    Default = _G.KillAura,
    Callback = function(Value)
        _G.KillAura = Value
...
v10MainSection:AddInput("Zyn_TextBox_6", {
...
v10MainSection:AddInput("Zyn_TextBox_7", {
...
local KillAuraCounter = 0
local KillAuraDisplay = v10MainSection:AddParagraph({
    Title = "Kill Aura Stats",
    Content = "Killed: 0"
})
...
-- Dropdown
v11MainSection:AddDropdown("Zyn_Dropdown_15", {
...
-- Auto Travel Toggle
v11MainSection:AddToggle("Zyn_Toggle_174", {
    Title = "Auto Travel",
...
v11MainSection:AddDropdown("Zyn_Dropdown_16", {
    Title = "Select Portal",
...
v11MainSection:AddDropdown("Zyn_Dropdown_17", {
    Title = "Select NPCs",
    Values = NPCList,
    Default = false,
    Multi = false,
...
v11MainSection:AddToggle("Zyn_Toggle_175", {
...
-- Stats Value Slider
local StatsValue = 10
v13MainSection:AddSlider("Zyn_Slider_3", {
    Title = "Stats Value",
    Min = 0,
    Max = 1000,
...
-- Auto Melee
v13MainSection:AddToggle("Zyn_Toggle_176", {
    Title = "Auto Melee",
...
-- Auto Sword
v13MainSection:AddToggle("Zyn_Toggle_177", {
    Title = "Auto Sword",
...
-- Auto Gun
v13MainSection:AddToggle("Zyn_Toggle_178", {
    Title = "Auto Gun",
...
-- Auto Blox Fruit
v13MainSection:AddToggle("Zyn_Toggle_179", {
...
-- Auto Defense
v13MainSection:AddToggle("Zyn_Toggle_180", {
    Title = "Auto Defense",
...
-- Player ESP
v13MainSection:AddToggle("Zyn_Toggle_181", {
    Title = "ESP Player",
...
-- Island ESP
v13MainSection:AddToggle("Zyn_Toggle_182", {
    Title = "ESP Island",
...
-- Fruit ESP
v13MainSection:AddToggle("Zyn_Toggle_183", {
    Title = "ESP Fruit",
...
-- Flower ESP
v13MainSection:AddToggle("Zyn_Toggle_184", {
    Title = "ESP Flower",
...
-- Chest ESP
v13MainSection:AddToggle("Zyn_Toggle_185", {
    Title = "ESP Chest",
...
-- Gear ESP (Mirage)
v13MainSection:AddToggle("Zyn_Toggle_186", {
...
v13MainSection:AddToggle("Zyn_Toggle_187", {
...
v13MainSection:AddToggle("Zyn_Toggle_188", {
...
-- Berry ESP
v13MainSection:AddToggle("Zyn_Toggle_189", {
    Title = "ESP Berry",
...
-- Dropdown chọn Melee
v14MainSection:AddDropdown("Zyn_Dropdown_18", {
    Title = "Chọn Melee Cần Mua",
...
v14MainSection:AddToggle("Zyn_Toggle_190", {
    Title = "Auto Mua (Bật/Tắt)",
        ...
        task.spawn(function()
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    Fluent:Notify({
                        Title = "Zyn Hub",
                        Content = "Lỗi: Không tìm thấy toạ độ cho Melee này ở Sea hiện tại!",
                        Duration = 3
                    })
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft Dragonstorm", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft DinoHood", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft SharkTooth", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft TerrorJaw", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft SharkAnchor", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft LeviathanCrown", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft LeviathanShield", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft LeviathanBoat", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft LegendaryScroll", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Craft", Content = "Đã craft MythicalScroll", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Geppo", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Buso Haki", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Soru", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Observation Haki", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Cutlass", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Katana", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Iron Mace", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Dual Katana", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Triple Katana", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Pipe", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Dual-Headed Blade", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Bisento", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Soul Cane", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Pole V2", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Slingshot", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Musket", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Flintlock", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Refined Slingshot", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Refined Flintlock", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Cannon", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Kabucha", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Bizarre Rifle", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Black Cape", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Swordsman Hat", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Shop", Content = "Đã mua Tomoe Ring", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Race", Content = "Đã đổi sang Ghoul", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Race", Content = "Đã đổi sang Cyborg", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Stats", Content = "Đã Reset Stats", Duration = 2})
    end
})
...
v14MainSection:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({Title = "Race", Content = "Đã Random Race", Duration = 2})
    end
})
...
-- Disable Chat GUI
v15MainSection:AddToggle("Zyn_Toggle_191", {
...
v15MainSection:AddToggle("Zyn_Toggle_192", {
...
v15MainSection:AddToggle("Zyn_Toggle_193", {
...
v15MainSection:AddDropdown("Zyn_Dropdown_19", {
...
-- RTX Mode (Visual)
v15MainSection:AddToggle("Zyn_Toggle_194", {
...
-- Full Bright
v15MainSection:AddToggle("Zyn_Toggle_195", {
    Title = "Full Bright",
...
v15MainSection:AddDropdown("Zyn_Dropdown_20", {
    Title = "Select Time",
    Values = TimeOptions,
    Default = "Day",
    Callback = function(Value)
...
v15MainSection:AddToggle("Zyn_Toggle_196", {
    Title = "Auto Set Time",
...
-- Ice Walk
v15MainSection:AddToggle("Zyn_Toggle_197", {
...
local PlayerDropdown = v12MainSection:AddDropdown("Zyn_Dropdown_21", {
...
v12MainSection:AddToggle("Zyn_Toggle_198", {
...
v12MainSection:AddToggle("Zyn_Toggle_199", {
...
-- Toggle khóa camera
v12MainSection:AddToggle("Zyn_Toggle_200", {
...
v12MainSection:AddToggle("Zyn_Toggle_201", {
    Title = "Aimbot Skills",
...
-- Toggle tốc độ
v12MainSection:AddToggle("Zyn_Toggle_202", {
    Title = "Set WalkSpeed",
...
v12MainSection:AddInput("Zyn_TextBox_8", {
...
-- Toggle nhảy
v12MainSection:AddToggle("Zyn_Toggle_203", {
    Title = "Set JumpPower",
...
v12MainSection:AddInput("Zyn_TextBox_9", {
...
v12MainSection:AddToggle("Zyn_Toggle_204", {
...
v12MainSection:AddToggle("Zyn_Toggle_205", {
...
-- Toggle vô hạn Soru
v12MainSection:AddToggle("Zyn_Toggle_206", {
...
v12MainSection:AddToggle("Zyn_Toggle_207", {
...
v12MainSection:AddToggle("Zyn_Toggle_208", {
...
v12MainSection:AddToggle("Zyn_Toggle_209", {
    Title = "Accept Allies",
