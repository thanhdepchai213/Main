...
------ Tabs (OK Hub style)
local Tabs = {
    Discord = Window:MakeTab({ Title = "Discord", Icon = "rbxassetid://6031071053" }),
    Config = Window:MakeTab({ Title = "Config", Icon = "rbxassetid://6031280882" }),
    Status = Window:MakeTab({ Title = "Status/Server", Icon = "rbxassetid://7040410130" }),
    Farming = Window:MakeTab({ Title = "Farming", Icon = "rbxassetid://10709769508" }),
    Quests = Window:MakeTab({ Title = "Quests/Other", Icon = "rbxassetid://10734943448" }),
    FarmSettings = Window:MakeTab({ Title = "Farm settings", Icon = "rbxassetid://10734950020" }),
    Fishing = Window:MakeTab({ Title = "Auto Fishing", Icon = "rbxassetid://127664059821666" }),
    SeaEvent = Window:MakeTab({ Title = "Sea Event", Icon = "rbxassetid://10747376931" }),
    Volcano = Window:MakeTab({ Title = "Volcano/Dojo", Icon = "rbxassetid://10734897956" }),
    Mirage = Window:MakeTab({ Title = "Mirage/Race", Icon = "rbxassetid://10734920149" }),
    Fruits = Window:MakeTab({ Title = "Fruits/Check Stock", Icon = "rbxassetid://10709790875" }),
    Raid = Window:MakeTab({ Title = "Raid/Dungoen", Icon = "rbxassetid://10723404337" }),
    Teleport = Window:MakeTab({ Title = "Teleport/World", Icon = "rbxassetid://10734906975" }),
    PvP = Window:MakeTab({ Title = "PvP/Player", Icon = "rbxassetid://10734975692" }),
    ESP = Window:MakeTab({ Title = "Esp/Stats", Icon = "rbxassetid://10723346959" }),
    Shop = Window:MakeTab({ Title = "Shop", Icon = "rbxassetid://10734952479" }),
    Settings = Window:MakeTab({ Title = "Settings", Icon = "rbxassetid://10734950309" })
}

-- Aliases giữ nguyên toàn bộ callback/chức năng cũ của Zyn
local v1, v2, v3, v4, v5 = Tabs.Status, Tabs.Farming, Tabs.Quests, Tabs.FarmSettings, Tabs.Fishing
local v6, v7, v8, v9, v10 = Tabs.SeaEvent, Tabs.Volcano, Tabs.Mirage, Tabs.Fruits, Tabs.Raid
local v11, v12, v13, v14, v15 = Tabs.Teleport, Tabs.PvP, Tabs.ESP, Tabs.Shop, Tabs.Settings
    ...
    Callback = function()
        pcall(function()
            if setclipboard then
                ...
                bearlib:Notify({Title = "Discord", Message = "Đã copy link Discord", Duration = 2})
            end
        end)
    end
})
...
-- Config
Tabs.Config:AddSection({Name = "Config"})
Tabs.Config:AddButton({
    Name = "Save Config",
    Callback = function()
        if SaveSettings() then
            bearlib:Notify({Title = "Config", Message = "Đã lưu config", Duration = 2})
        end
    end
})
Tabs.Config:AddButton({
    ...
    Callback = function()
        if LoadSettings() then
            bearlib:Notify({Title = "Config", Message = "Đã tải config", Duration = 2})
        end
    end
})
