...
-- Xeter-style UI ON/OFF indicator
-- ON = Fluent window visible, OFF = Fluent window minimized/hidden.
local PlayerGui = LocalPlayer:WaitForChild("PlayerGui")

local UIStatusGui = Instance.new("ScreenGui")
UIStatusGui.Name = "W_Azeox_UIStatus"
UIStatusGui.ResetOnSpawn = false
UIStatusGui.IgnoreGuiInset = true
UIStatusGui.DisplayOrder = 999999
UIStatusGui.Parent = PlayerGui

local UIStatus = Instance.new("TextButton")
UIStatus.Name = "Status"
UIStatus.Position = UDim2.new(0, 150, 0.30, 0)
UIStatus.Size = UDim2.fromOffset(100, 70)
UIStatus.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
UIStatus.BorderSizePixel = 0
UIStatus.AutoButtonColor = false
UIStatus.Text = "OFF"
UIStatus.TextColor3 = Color3.fromRGB(255, 255, 255)
UIStatus.TextSize = 25
UIStatus.Font = Enum.Font.GothamBold
UIStatus.Parent = UIStatusGui

local UIStatusCorner = Instance.new("UICorner")
UIStatusCorner.CornerRadius = UDim.new(0, 10)
UIStatusCorner.Parent = UIStatus

local UIStatusStroke = Instance.new("UIStroke")
UIStatusStroke.Thickness = 1
UIStatusStroke.Transparency = 0.35
UIStatusStroke.Color = Color3.fromRGB(80, 80, 80)
UIStatusStroke.Parent = UIStatus
...
local function UpdateUIStatus()
    pcall(function()
        ...
        UIStatus.Text = visible and "ON" or "OFF"
        UIStatus.BackgroundColor3 = visible
            and Color3.fromRGB(0, 150, 70)
            or Color3.fromRGB(0, 0, 0)
    end)
end

-- Follow Fluent's minimize/restore state.
task.spawn(function()
    while UIStatusGui.Parent do
        UpdateUIStatus()
        task.wait(0.15)
    end
end)

-- Tap/click the ON/OFF box to toggle the window.
UIStatus.MouseButton1Click:Connect(function()
    pcall(function()
        local root = Fluent.Window and Fluent.Window.Root
        if root then
